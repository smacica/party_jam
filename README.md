...
* **Host Moderation & Regulation:** * Toggle queue permissions on/off instantly. 
...
4.  **Run the server:**
    ...
    npm start
    ```
    > **Note:** The app will automatically initialize the SQLite database on first boot. Open `http://localhost:3000` to start your party room.
